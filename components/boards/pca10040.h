...
#define SER_APP_RX_PIN              30    // UART RX pin number.
#define SER_APP_TX_PIN              31    // UART TX pin number.
...
#define SER_CON_RX_PIN              30    // UART RX pin number.
#define SER_CON_TX_PIN              31    // UART TX pin number.
